...
class Rollbar extends Component
{
    ...
    public function getJsTrackingCode()
    {
        ...
        var _rollbarConfig = {
            ...
            captureUnhandledRejections: '.($captureUnhandledRejections ? 'true' : 'false').',
            payload: {
